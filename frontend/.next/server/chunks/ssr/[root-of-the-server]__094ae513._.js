...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$productCard$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/productCard.tsx [app-ssr] (ecmascript)"); // importe o ProductCard
'use client';
;
;
;
...
function Home() {
    ...
    async function loadProducts() {
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/products');
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            if (editingProduct) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/products/${editingProduct.id}`, {
                    title,
                    description,
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/products', {
                    title,
                    description,
                    price: parseFloat(price),
                    image_url: imageUrl
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/products/${id}`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__094ae513._.js.map