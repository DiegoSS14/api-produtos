...
"[project]/src/components/ui/searchHeader.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
function SearchHeader(param) {
    let { onNewProductClick, onLogoutClick } = param;
    _s();
    ...
    const handleSearchSubmit = (e)=>{
        e.preventDefault();
        if (searchTerm.trim()) {
            router.push("/search?search=".concat(encodeURIComponent(searchTerm.trim())));
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                ...
                fileName: "[project]/src/components/ui/searchHeader.tsx",
                lineNumber: 25,
                columnNumber: 7
            }, this),
...
_s(SearchHeader, "C3izi03T2Um0j+iiaoZoqXFo2SM=", false, function() {
    return [
...
function ProductCard(param) {
    let { product, onEdit, onDelete } = param;
    const handleDelete = ()=>{
...
{
__turbopack_context__.s({
    "default": ()=>ProductSearchPage
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$searchHeader$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/searchHeader.tsx [app-client] (ecmascript)");
...
function ProductSearchPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductSearchPage.useEffect": ()=>{
            ...
            const fetchProducts = {
                "ProductSearchPage.useEffect.fetchProducts": async ()=>{
                    try {
                        setLoading(true);
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("http://localhost:3333/products/search?query=".concat(query), {
                            headers: {
                                Authorization: "Bearer ".concat(token)
                            }
                        });
                        const data = response.data;
                        setProducts(data.products ? data.products : data.product ? [
                            data.product
                        ] : []);
                    } catch (err) {
            ...
            }["ProductSearchPage.useEffect.fetchProducts"];
            if (query.trim()) {
                fetchProducts();
            } else {
                setProducts([]);
    ...
    async function loadProducts() {
        ...
        try {
            setLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:3333/products', {
                headers: {
                    Authorization: "Bearer ".concat(token)
                }
            });
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            if (editingProduct) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put("http://localhost:3333/products/".concat(editingProduct.id), {
                    title,
                    description,
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:3333/products', {
                    title,
                    description,
                    price: parseFloat(price),
                    image_url: imageUrl
            ...
            const errors = (_err_response = err.response) === null || _err_response === void 0 ? void 0 : (_err_response_data = _err_response.data) === null || _err_response_data === void 0 ? void 0 : _err_response_data.errors;
            if (Array.isArray(errors) && errors.length > 0) {
                setError(errors[0].message);
            } else {
                var _err_response_data1, _err_response1;
                setError(((_err_response1 = err.response) === null || _err_response1 === void 0 ? void 0 : (_err_response_data1 = _err_response1.data) === null || _err_response_data1 === void 0 ? void 0 : _err_response_data1.message) || 'Erro inesperado ao salvar o produto.');
            }
        }
    };
    const handleDelete = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete("http://localhost:3333/products/".concat(id), {
                headers: {
                    Authorization: "Bearer ".concat(localStorage.getItem('token'))
                }
            });
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$searchHeader$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SearchHeader"], {
...
_s(ProductSearchPage, "8Gc7hCRZAwbaWlH1E20jgPDYjTk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = ProductSearchPage;
var _c;
__turbopack_context__.k.register(_c, "ProductSearchPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_5a089fdf._.js.map