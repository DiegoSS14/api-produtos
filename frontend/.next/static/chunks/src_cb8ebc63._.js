...
function Home() {
    ...
    async function loadProducts() {
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/products');
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        setError(null); // Apaga os erros anteriores
        try {
            if (editingProduct) {
                // Editar produto
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put("/products/".concat(editingProduct.id), {
                    title,
                    description,
                ...
                // Criar produto
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/products', {
                    title,
                    description,
                    price: parseFloat(price),
                    image_url: imageUrl
            ...
            if (Array.isArray(errors) && errors.length > 0) {
                setError(errors[0].message); // pega a primeira mensagem do array
            } else {
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete("/products/".concat(id));
...
_s(Home, "cjWLWSwGHhD42YbFDLtH5w9UOFo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=src_cb8ebc63._.js.map